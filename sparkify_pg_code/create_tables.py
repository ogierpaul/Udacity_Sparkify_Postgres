...
def create_database(drop_create_database=False):
    """
    - Creates and connects to the sparkifydb
    - Returns the connection and cursor to sparkifydb
    Args:
        drop_create_database (bool): If True, drop and re-create the database
    Returns:
        psycopg2.cursor, psycopg2.connection
    """
...
def main():
    ...
    """
    cur, conn = create_database(drop_create_database=drop_create_database)
